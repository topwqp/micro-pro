...
echo "start eureka...."
/xs/app/jdk1.8.0_202/bin/java -jar -XX:+UnlockExperimentalVMOptions -XX:+UseCGroupMemoryLimitForHeap -XX:MaxRAMFraction=1 -Xms512M -XX:+HeapDumpOnOutOfMemoryError -XX:HeapDumpPath=/xs/logs/oom.hprof /xs/webapps/micro-eureka/micro-eureka-0.0.1-SNAPSHOT.jar --spring.profiles.active=k8sonline --eureka.server.enable-self-preservation=false
